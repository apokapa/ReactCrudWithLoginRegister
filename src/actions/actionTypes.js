...
export const BEGIN_AJAX_CALL = 'BEGIN_AJAX_CALL'; //Triggers that there is an ajax calls going on , for loaders etc.
export const AJAX_CALL_ERROR = 'AJAX_CALL_ERROR'; //Api error

export const LOAD_PRODUCTS_SUCCESS = 'LOAD_PRODUCTS_SUCCESS'; //Load all products success action
export const CREATE_PRODUCT_SUCCESS = 'CREATE_PRODUCT_SUCCESS'; //Creat product success action
